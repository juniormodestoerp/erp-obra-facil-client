...
export function MobileSidebar() {
	return (
		<div className="absolute left-0 h-full w-full bg-white lg:hidden">
			<Disclosure as="nav" className="w-full border-b border-zinc-300 bg-white">
				{({ open }) => (
					<>
						...
						<DisclosurePanel className="w-full border-t border-zinc-300 flex flex-col bg-white h-full">
							<div className="space-y-1 pb-2 pt-2">
								...
								<MobileOption linkTo="/bank-accounts" title="Contas" />
								<MobileOption

              ...
              <div className="flex items-center">
                {selectedField ? (
                  selectedField.field.includes(' - ') ? (
                    ...
                    <>
                      {createElement(
                        iconComponents[selectedField.field as keyof typeof iconComponents],
                        { className: 'inline-block h-6 w-6 mr-2' }
                      )}
                      <span
                        className={cn(
            ...
            <CommandDialog open={isOpen} onOpenChange={setIsOpen}>
              ...
              <CommandList>
                  ...
                  {Object.keys(iconComponents).map((iconName) => {
                    ...
                    return (
                      <CommandItemOption
                        key={iconName}
                        onSelect={() => {
                          const selectedIcon = { field: iconName, value: iconName };
                ...
                {filteredData.length > 0 && (
                  <CommandGroup heading="Instituições financeiras" className='cursor-pointer'>
